...
Noise_Source_Dir = '../data/theft_experiment_5min/N1_D-70/0-114/data'
...
def generate_theft(frequency, total_house, daily_theft_num):
    ...
    # Method 5 &6, no values needed for pre-generation

    # Theft & Usage brief info
    #log_file = os.path.join(theft_folder, "theft-brief-info")
    #with open(log_file, 'w') as f:
    #    f.write("Day:{}-{}".format(Start_Day, End_Day))
    #    f.write("Apt:{}-{}".format(Start_Apt, End_Apt))
